...
setlocale(LC_TIME, "heb-heb.UTF-8", "heb-heb", "hebrew.UTF-8", "hebrew");
} else {
setlocale(LC_TIME, "he_IL.UTF-8", "heb.UTF-8", "he.UTF-8", "iw_IL.UTF-8", "iw.UTF-8", "heb_heb.UTF-8", "Hebrew-he.UTF-8"); // For HE formats
}
?>