...
setlocale(LC_TIME, "arm-ARM.UTF-8", "arm-ARM", "Armenian-ARM.UTF-8", "Armenian.UTF-8");
} else {
setlocale(LC_TIME, "hy_AM.UTF-8", "arm.UTF-8", "ARM.UTF-8", "arm_ARM.UTF-8", "Armenian-ARM.UTF-8");
}
?>