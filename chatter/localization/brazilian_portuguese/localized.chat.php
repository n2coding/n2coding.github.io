<?php
// File : brazilian_portuguese/localized.chat.php - plus version (04.11.2017 - rev.50) - 48-49 to check
...
define("L_COOKIE", "%s utiliza cookies para melhorar a experiência de navegação e fornecer funcionalidades extra.<br />Nenhuns dados relacionados serão utilizados para o identificar ou contactar."); //app name //rev.50
define("L_PRIVACY", "Política de Privacidade"); //rev.50
define("L_READ_PRIVACY", "para ler a sua ".L_PRIVACY.""); //rev.50
define("L_AGREE", "Entendi!"); //rev.50
