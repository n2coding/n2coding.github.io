<?php
// File : _owner/ower.php - plus version (06.10.2018 - rev.2)
...
# Please note that the topics themselves are not multilingual!
...
# Never modify the original language/localized.chat.php, if you want to still be able to apply the upgrades to the next releases in a easy way.
