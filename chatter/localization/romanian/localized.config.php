<?php
// File : romanian/localized.config.php - plus version (05.11.2017 - rev.6)
// Translation by Ciprian Murariu <ciprianmp@yahoo.com>
// Do not use ' but use ’ instead (utf-8 edit bug)

//Configuration Global used variables
define("A_CONFSAVE", "Salvează Modificările");
define("A_CONFOPTIONAL", "Opţional");
define("A_CONFREQUIRED", "Obligatoriu");
define("A_CONFNOTSEND", "Nu trimite");
define("A_CONFSEND", "Trimite");
define("A_CONFUNRESTRICT", "Nerestricţionat");
define("A_CONFRESTRICT", "Restricţionat");
define("A_CONFHIDE", "Ascunde");
define("A_CONFSHOW", "Arată");
define("A_CONFHINT", "Sfat: %s");
define("A_CONFIMPORTANT", "Important: %s");
define("A_CONFNOTE", "Notă: %s");
define("A_CONFHERE", "aici");
define("A_CONFWIDTH", "Lăţime");
define("A_CONFHEIGHT", "Înălţime");
define("A_CONFPX", "px."); #pixels
define("A_CONFBOT", "RoBoţel");
define("A_CONFRDQ", "Citat Aleatoriu");

//Navigation Menu
define("A_CONF_0", "Setări Generale");
define("A_CONF_1", "Informaţii despre Chat");
define("A_CONF_2", "Limbi");
define("A_CONF_3", "Date Proprietar");
define("A_CONF_4", "Înregistrare");
define("A_CONF_5", "Funcţionalitate");
define("A_CONF_6", "Temporale");
define("A_CONF_7", "Orar de Funcţionare");

define("A_CONF_26", "Interfaţă");
define("A_CONF_8", "Aspect Login");
define("A_CONF_9", "Camere şi Teme");
define("A_CONF_10", "Culori");
define("A_CONF_11", "Setări de Sunet");
define("A_CONF_12", "Expresii vulgare");
define("A_CONF_13", "Gestionare Upload-uri");

define("A_CONF_14", "Facilităţi şi Moduri");
define("A_CONF_15", "Mesagerie Privată");
define("A_CONF_16", "Setări RoBoţel");
define("A_CONF_17", "Comenzi");
define("A_CONF_18", "Multimedia");
define("A_CONF_19", "Meniuri Rapide");
define("A_CONF_20", "Avataruri şi Gravatare");
define("A_CONF_21", "Modul Arhivare");
define("A_CONF_22", "Modul Lurking");
define("A_CONF_23", "Citat Aleatoriu");
define("A_CONF_24", "Controlul Fantomelor");
define("A_CONF_25", "Modul Aniversare");
define("A_CONF_45", "GeoIP Country Flags");

define("A_CONF_27", "Ajutor şi Suport");
define("A_CONF_28", "Pagina de Download");
define("A_CONF_29", "Pagina Mirror");
define("A_CONF_30", "Pagina Proiectului");
define("A_CONF_31", "Pagina Proiectului SVN");
define("A_CONF_32", "Pagina Grup Suport");
define("A_CONF_33", "Citeşte noutăţile din %s"); //%s = version
define("A_CONF_35", "Descarcă actualizarea %s"); //%s = version
define("A_CONF_36", "Online FAQ");
define("A_CONF_37", "Server Încercare");
define("A_CONF_38", "Trimite-ne feedback");
define("A_CONF_39", "Doreşti să donezi?");
define("A_CONF_40", "Lansat la data de:\\n%s"); //%s = date
define("A_CONF_41", "Dezvoltator Plus: %s"); //%s = developer name
define("A_CONF_42", "Multe mulţumiri tuturor contributorilor\\nla munca echipei phpHeaven Team\\nşi grupurilor phpMyChat de la\\nYahoo! şi Sourceforge.\\n\\nSperăm că vă place produsul nostru!");
define("A_CONF_43", "Ce este asta?");
define("A_CONF_44", "Despre Plus");

define("A_CONF_46", "Acasă");
define("A_CONF_46a", "Navighează Acasă");
define("A_CONF_47", "Salvează");
define("A_CONF_47a", "Sari la butonul Salvează");

//Content - Errors Success
define("A_CONF_ERR_1", "Setările de Configurare au fost Salvate cu Succes!");
define("A_CONF_ERR_2", "Nu uita să redenumeşti directorul %s în %s prin ftp (şi să-i schimbi permisiunile la <b>777</b>)"); // %s = folder names (old|new)
define("A_CONF_ERR_3", "Descarcă actualizarea %s de %s."); //%s = version | here (url)
define("A_CONF_ERR_4", "Descarcă actualizarea %s"); //%s = version
define("A_CONF_ERR_5", "Aceste setări au fost salvate ultima dată %s de către %s!");  //%s = date | admin username
define("A_CONF_ERR_6", "Trebuie să introduci un nume pentru %s!"); //%s = Bot/Quote word
define("A_CONF_ERR_7", "Sunt permise doar aceste extra-caractere:");
define("A_CONF_ERR_8", "Spaţiile, virgulele şi backslashes (\\) nu sunt permise.<br />Verifică sintaxa numelui acordat pentru %s (%s)!"); //%s = Bot/Quote word | (Bot/Quote names)
define("A_CONF_ERR_9", "Aţi utilizat un cuvânt interzis la definirea numelui acordat pentru %s (%s)!"); //%s = Bot/Quote word | (Bot/Quote names)
define("A_CONF_ERR_10", "Numele acordat pentru %s (%s) este deja înregistrat.<br />Alegeţi un alt nume!"); //%s = Bot/Quote word | (Bot/Quote names)
define("A_CONF_ERR_11", "Dacă modificaţi această setare în timpul în care se află utilizatori autentificaţi pe chat, toţi aceştia vor trebui să îşi reîncarce browserul (F5) sau să iasă şi să se autentifice din nou. Un anunţ va fi trimis automat în toate camerele de chat, dacă activezi/dezactivezi această opţiune.");

//Content - Title
define("A_CONFTITLE_0", "Pagina de Configurare");
define("A_CONFTITLE_1", "Opţiuni de Configurare");
define("A_CONFTITLE_2", "Setări Actuale");

//Content - Chat Server Data
define("A_CONFCONTENT_1", "Activează verificarea automată a actualizărilor disponibile pe serverele de distribuţie.");
define("A_CONFCONTENT_2", "Scriptul poate verifica automat disponibilitatea unor versiuni mai noi la adresele: ciprianmp.com/latest/ sau svn.sourceforge.net!");
define("A_CONFCONTENT_3", "Activează Statisticile în chat.");
define("A_CONFCONTENT_4", "Dacă lăţimea de bandă a serverului este foarte redusă sau dacă observi o supraîncărcare a serverului, este de preferat să dezactivezi această opţiune!");
define("A_CONFCONTENT_5", "Timpul de curăţare pentru mesajelor vechi.");
define("A_CONFCONTENT_7", "Timpul de eliminare automată a utilizatorilor inactivi din camere.");
define("A_CONFCONTENT_8", "Această facilitate de eliminare automată va forţa utilizatorii să fie activi în camere. Dacă aceştia doresc doar să monitorizeze ce se discută, n-au decât să deschidă Pagina de Monitorizare. Administratorii, moderatorii şi utilizatorii cu starea Plecat nu vor fi eliminaţi automat.");
define("A_CONFCONTENT_10", "Şterge conturile utilizatorilor înregistraţi care nu au mai folosit chatul în acest interval (0 pentru niciodată).");
define("A_CONFCONTENT_11", "Setează modul în care rulează acest server de chat."); //rev.2
define("A_CONFCONTENT_11a", "Modul Plugin nu este încă implementat. Aici vor fi afişate, în viitor, instrucţiunile pentru folosirea phpMyChat ca un plugin pentru phpnuke/phpbb ."); //rev.2 
define("A_CONFCONTENT_11b", "Calea către directorul local Nuke/phpBB:"); //rev.2

//Content - Languages
define("A_CONFCONTENT_12", "Limba Implicită a Chatului.");
define("A_CONFCONTENT_12a", "Selectorul Steagului Limbii");
define("A_CONFCONTENT_13", "Formatul Englezesc (pentru steaguri şi formatele de dată şi timp).");
define("A_CONFCONTENT_13a", "Formatul limbii Engleze");
define("A_CONFCONTENT_14", "Permite utilizatorilor să îşi selecteze una traducerile disponibile.");
define("A_CONFCONTENT_14_1", "Numai implicită");
define("A_CONFCONTENT_14_2", "Toate disponibile");
define("A_CONFCONTENT_15", "Tipul imaginii Steagurilor.");
define("A_CONFCONTENT_15a", "Formatul Steagurilor");
define("A_CONFCONTENT_15b", "2D (std)");
define("A_CONFCONTENT_15c", "3D (nou)");

//Content - Owner data
define("A_CONFCONTENT_16", "Introduceţi numele real al administratorului (sau al chat-ului) pentru a fi utilizat în email-uri.");
define("A_CONFCONTENT_17", "Introduceţi emailul administratorului pentru a fi utilizat în emailuri.");
define("A_CONFCONTENT_18", "şi pentru a primi notificări la înregistrarea noilor utilizatori.");
define("A_CONFCONTENT_19", "Introduceţi URL-ul chat-ului pentru a fi afişat în email-uri.");
define("A_CONFCONTENT_20", "Introduceţi Salutul Implicit de Încheiere pentru emailuri.");
define("A_CONFCONTENT_21", "Va fi folosit doar de administratori în secţiunea \"".A_MENU_4."\".");
define("A_CONFCONTENT_22", "Numele Public al serverului de chat, aşa cum doriţi să fie cunoscut pe web.");
define("A_CONFCONTENT_23", "Calea către imagine de LOGO.");
define("A_CONFCONTENT_23_1", "Ascunde Logo");
define("A_CONFCONTENT_23_2", "Arată Logo");
define("A_CONFCONTENT_24", "Imaginea Logo ce va fi afişată (sunt permise atât căi absolute cât şi relative) - Ex. http://path_to_the_image.jpg or ./../calea_către_imagine.jpg");
define("A_CONFCONTENT_25", "(calea_către_imagine.jpg poate fi orice imagine accesibilă public pe internet - .jpg, .gif, .bmp, .png)");
define("A_CONFCONTENT_26", "URL-ul ce va fi deschis la click pe LOGO (se va deschide în fereastră nouă).");
define("A_CONFCONTENT_27", "Textul ce va fi afişat de către LOGO la suprapunerea pointerului (proprietatea ALT/TITLE).");

//Content - Registration
define("A_CONFCONTENT_28", "Permite Înregistrarea pe chat a noilor utilizatori.");
define("A_CONFCONTENT_29", "Dezactivaţi numai dacă doriţi să adăugaţi manual utilizatorii, sau citiţi <a href=#reg_hint class=\"ChatLink\">Sfatul</a> pentru a o face automat, dar cu aprobarea administratorului.");
define("A_CONFCONTENT_30", "Solicită Înregistrarea Obligatorie pentru a putea accesa chatul.");
define("A_CONFCONTENT_31", "Prenumele şi Numele de Familie sunt obligatorii la înregistrare şi în profile.");
define("A_CONFCONTENT_32", "Generează şi transmite în mod Automat Parola prin email la noii utilizatori, după înregistrare.");
define("A_CONFCONTENT_33", "Lungimea Parolei ce va fi generată şi transmisă prin email.");
define("A_CONFCONTENT_34", "Trimite detaliile contului la noul utilizator după înregistrare.");
define("A_CONFCONTENT_35", "Trimite detaliile contului (informare) la administrator după înregistrarea unui nou utilizator.");
define("A_CONFCONTENT_37", "pentru setările recomandate dacă doriţi să aveţi controlul asupra cine se poate înregistra pentru a accesa chatul:");
define("A_CONFCONTENT_38", "Permite Înregistrarea pe chat a noilor utilizatori:");
define("A_CONFCONTENT_39", "Solicită Înregistrare Obligatorie pentru a putea accesa chatul: dacă este setat ca %s, numai utilizatorii înregistraţi vor putea să se autentifice pe chat"); // %s = Required
define("A_CONFCONTENT_41", "Generează şi transmite în mod Automat Parola prin email la noii utilizatori, după înregistrare:");
define("A_CONFCONTENT_42", "Trimite detaliile contului la noul utilizator după înregistrare:");
define("A_CONFCONTENT_43", "Trimite detaliile contului (informare) la administrator după înregistrarea unui nou utilizator:");
define("A_CONFCONTENT_44", "Ca urmare, utilizatorul îşi va seta propriile informaţii, o parolă aleatorie va fi generată, dar utilizatorul nu o va primi prin email, aşa că încă nu se va putea autentifica pe chat; va primi doar o informare despre faptul că se aşteaptă aprobarea contului nou creat.");
define("A_CONFCONTENT_45", "În acelaşi timp, administratorul va primi <u>2 emailuri</u>:");
define("A_CONFCONTENT_46", "Primul - este o copie a informaţiilor folosite la înregistrarea contului, pentru nevoile viitoare de administrare (Ex. când utilizatorul îşi uită parola). Acest email va fi doar în limba engleză;");
define("A_CONFCONTENT_47", "Al 2 <sup><u>lea</u></sup> - este emailul care conţine parola generată de server şi celelalte informaţii folosite de utilizator la înregistrarea contului (acest email este deja pregătit pentru a fi retransmis de către administrator la adresa de email a noului utilizator, după aprobarea acestuia). Acest email este de obicei tradus în limba pe care însuşi noul utilizator a ales-o la crearea contului.");
define("A_CONFCONTENT_48", "Administratorul verifică cine este persoana pe baza informaţiilor folosite în formular. După verificare, dacă decide să aprobe noul cont, tot ce va trebui să facă administratorul este să retransmită acest al doilea email la adresa de email a noului utilizator (emailul este deja pregătit pentru aprobare). O altă posibilitate este ca administratorul să acceseze secţiunea %s şi să trimită un email cu datele de autentificare la adresa de email a noului utilizator. Opţional, administratorul se poate chiar autentifica cu numele şi parola nou create în formularul \"".L_REG_4."\" şi să ajusteze/schimbe informaţiile şi/sau parola noului utilizator, înainte de a trimite aprobarea."); //%s = tab name
define("A_CONFCONTENT_50", "Nu uitaţi să introduceţi o adresă de email corectă %s, pentru ca toţi aceşti paşi să funcţioneze. De asemenea, trebuie să ţineţi cont că această abordare a setărilor va tanforma chatul într-unul fără accesul publicului (restricţionat, privat). Dacă nu veţi verifica şi autoriza noii utilizatori într-un interval de timp rezonabil, aceştia se vor simţi ignoraţi şi s-ar putea să renunţe a vă mai vizita chatul."); //%s = here (url)
...
define("A_CONFCONTENT_167", "Display the name of your RoBoțel (if available).");
define("A_CONFCONTENT_168", "Hide RoBoțel name");
define("A_CONFCONTENT_169", "Show RoBoțel name");
...
define("A_CONFCONTENT_248a", "On new message:"); //rev.6
...
define("A_CONFCONTENT_276", "Enable RoBoțel in chat.");
define("A_CONFCONTENT_277", "Before changing any of the RoBoțel settings below, please stop the RoBoțel if it is running in the chat (you will not be able to kick it out afterwards, because it is set as admin).");
define("A_CONFCONTENT_278", "Enable Public conversations with RoBoțel in chat.");
define("A_CONFCONTENT_279", "if you disable this, the RoBoțel will only listen and talk to users using private messages in chat.");
define("A_CONFCONTENT_280", "Private RoBoțel Only");
define("A_CONFCONTENT_281", "Public RoBoțel");
define("A_CONFCONTENT_282", "Enter the desired name for your RoBoțel.");
define("A_CONFCONTENT_283", "Do not change the name before you make sure RoBoțel is fully loaded. You can do this by checking if it answers you on this private chat page: %s !"); //%s = page name (url)
define("A_CONFCONTENT_284", "Your RoBoțel has not been correctly loaded! Read the \"%s\".");
define("A_CONFCONTENT_285", "RoBoțel status & maintenance.");
define("A_CONFCONTENT_286", "If your RoBoțel is not responding properly (posts empty messages) and/or the RoBoțel ID <> 1, you might need to reload your RoBoțel. This operation will empty the RoBoțel tables in the database and reload the entire script.");
define("A_CONFCONTENT_287", "Your RoBoțel is not loaded to the DB.");
define("A_CONFCONTENT_288", "Click <a href=\"./bot/botloader.php\" target=\"_blank\">".A_CONFHERE."</a> to load it now!");
define("A_CONFCONTENT_289", "RoBoțel ID:");
define("A_CONFCONTENT_291", "Click <a href=\"./bot/botloader.php\" target=\"_blank\" class=\"error\">".A_CONFHERE."</a> to reload RoBoțel!");
define("A_CONFCONTENT_292", "Enter the color of the RoBoțel response messages.");
define("A_CONFCONTENT_293", "Enter the avatar of the RoBoțel.");
define("A_CONFCONTENT_294", "It will be shown only if the avatar system is enabled");
define("A_CONFCONTENT_294a", "RoBoțel Avatar");
define("A_CONFCONTENT_295", "Enter the message to be posted by RoBoțel on start.");
define("A_CONFCONTENT_296", "Avoid special characters or the settings will not be saved.");
define("A_CONFCONTENT_297", "Enter the message to be posted by RoBoțel on stop.");
...
define("A_CONFCONTENT_335a", "Media Player Preview"); //rev.5
define("A_CONFCONTENT_336", "The path to the streaming URL.");
define("A_CONFCONTENT_336a", "Before going live, you should test your own URLs. Open the %s page for some working examples of streaming formats and more info."); //rev.5
define("A_CONFCONTENT_336b", "Browsers are still using some different technologies, therefore some formats might not work in all browsers. Testing with different browsers will help you make the best decision and know the limitations.<br />We will try to improve the cross-browser compatibility of this HTML5 Media Player, so keep looking out for ".APP_NAME." updates."); //rev.5
...
define("A_CONFCONTENT_377", "MySQL/Database Server version:");
...
define("A_CONFCONTENT_389", "This will randomly return a dynamic image for each user who don’t have a gravatar.com account for their email (chat guests and/or users without a registered gravatar.com account).");
...
define("A_CONFCONTENT_432", "Setează fişierul text de unde să fie extrase Urările.");
