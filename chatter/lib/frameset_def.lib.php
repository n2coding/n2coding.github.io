...
if ((isset($dropdownmsga) && ($status == "a" || $status == "t")) || (isset($dropdownmsgm) && $status == "m") || isset($dropdownmsg))
{
	...
	{
?>
			<FRAMESET ROWS="45,*,60" FRAMEBORDER="0" BORDER="0" FRAMESPACING="0">
<?php
	}
	else
	{
?>
			<FRAMESET ROWS="30,*,60" FRAMEBORDER="0" BORDER="0" FRAMESPACING="0">
<?php
	}
}
else
{
	...
	{
?>
			<FRAMESET ROWS="45,*,35" FRAMEBORDER="0" BORDER="0" FRAMESPACING="0">
<?php
	}
	else
	{
?>
			<FRAMESET ROWS="30,*,35" FRAMEBORDER="0" BORDER="0" FRAMESPACING="0">
<?php
	}
}
?>
...
if ((isset($dropdownmsga) && ($status == "a" || $status == "t")) || (isset($dropdownmsgm) && $status == "m") || isset($dropdownmsg))
{
  ...
  {
?>
			<FRAMESET ROWS="45,*,55" BORDER="0">
<?php
	}
	else
	{
?>
			<FRAMESET ROWS="30,*,55" BORDER="0">
<?php
	}
}
else
