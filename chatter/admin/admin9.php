...
#					if (!eregi("index\.html",$ip) && !eregi("chat_ip_logs\.htm",$ip) && !eregi("error",$ip) && $ip!='.' && $ip!='..' && !is_dir($ipbak."/".$ip))
					if (!preg_match("/(index\.html|chat_ip_logs\.htm|error|error_log)$/i", $ip) && !preg_match("/^[\.]/", $ip) && !is_dir($ipbak."/".$ip))
					{
						$iparray[]=$ip;
			 		}
			 	}
...
#					if (!eregi("\.html",$dy) && !eregi("_vti_conf",$dy) && !eregi("error",$dy) && $dy!='.' && $dy!='..')
					if (!preg_match("/(\.html|_vti_conf|_vti_cnf|error|error_log)$/i", $dy) && !preg_match("/^[\.]/", $dy))
					{
						$dayarray[]=$dy;
			 		}
			 	}
...
#					if (!preg_match("/(\.html|error|error_log)$/i", $zy) && !preg_match("/^[\.]/", $zy) && !is_dir($y."/".$zy)
					{
						$ziparray[]=$zy;
			 		}
			 	}
...
#					if (!eregi("\.html",$dyu) && !eregi("_vti_conf",$dyu) && !eregi("error",$dyu) && $dyu!='.' && $dyu!='..')
					if (!preg_match("/(\.html|_vti_conf|_vti_cnf|error|error_log)$/i", $dyu) && !preg_match("/^[\.]/", $dyu))
					{
						$dayarrayu[]=$dyu;
			 		}
			 	}
...
else
{
		...
		$zipu = opendir($yu); #open directory
				...
				{
#					if (!eregi("\.html",$zyu) && !eregi("error",$zyu) && $zyu!='.' && $zyu!='..' && !is_dir($yu."/".$zyu))
					if (!preg_match("/(\.html|error|error_log)$/i", $zyu) && !preg_match("/^[\.]/", $zyu) && !is_dir($yu."/".$zyu))
					{
						$ziparrayu[]=$zyu;
			 		}
			 	}
