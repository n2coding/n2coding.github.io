...
#               $pattern .= " $key=\"$val\" ";
#           }
			foreach($attrs as $key => $val) $pattern .= " $key=\"$val\" ";
...
#           $template .= " $key=\"$val\" ";
#       }
		foreach($attrs as $key => $val) $template .= " $key=\"$val\" ";
